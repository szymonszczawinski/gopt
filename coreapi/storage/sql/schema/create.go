...
const (
	...
	CREATE_TABLE_PROJECT          string = "CREATE TABLE IF NOT EXISTS project " +
		"(id BIGSERIAL PRIMARY KEY, created TIMESTAMP NOT NULL, updated TIMESTAMP NOT NULL, name TEXT NOT NULL, project_key TEXT NOT NULL, item_number INTEGER NOT NULL, " +
